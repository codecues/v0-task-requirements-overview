  ...
  return (
    <main className="w-full max-w-[1200px] mx-auto p-6 bg-white rounded-xl shadow-lg">
      <div className="bg-white p-5 rounded-xl shadow-md mb-8">
        <h2 className="text-xl font-bold text-primary-700 mb-4">Project Requirements</h2>
        <p className="text-gray-700 leading-relaxed mb-3">
          This project management system enables teams to track tasks with T-shirt sizing, manage resource allocation,
          and visualize timelines via Gantt charts. It provides real-time capacity planning, dependency tracking, and
          cost analysis. The interface allows for easy task creation, assignment to team members, and progress
          monitoring.
        </p>
